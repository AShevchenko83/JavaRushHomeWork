...
7. Дай экзэкьютору 5 секунд на завершение всех тасок (метод awaitTermination
...
public class Solution {
    public static void main(String[] args) throws InterruptedException {
        ...
        ThreadPoolExecutor execut= new ThreadPoolExecutor(3, 5,1000, TimeUnit.MILLISECONDS, queue);;
        execut.prestartAllCoreThreads();
        execut.shutdown();
        execut.awaitTermination(5 , TimeUnit.SECONDS);
