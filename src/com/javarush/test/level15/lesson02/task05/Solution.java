...
1. Поведение программы осталось прежним, т.е. она должна выдавать то же самое,
что и выдает сейчас
2. Метод containsBones должен возвращать тип Object и значение "Yes" вместо true,
"No" вместо false
*/
...
public class Solution {
    ...
    public static class Finger extends BodyPart {
        ...
        /*public Object containsBones() {
            if(!isFoot) return super.getName() + " не содержит кости";
            else return super.getName() + " содержит кости";
        }*/
