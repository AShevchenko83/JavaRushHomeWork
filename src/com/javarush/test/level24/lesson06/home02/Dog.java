...
public class Dog implements Pet {
    ...
    public Sayable toSayable(final int i) {
        ...
        final String dogName=name;
       class DogPet extends SuperDog implements Sayable{
           private String dogPetName = dogName;
           private int count = i;
           private String getName(){
               return getSuperQuotes()+dogPetName+getSuperQuotes();
           }
           @Override
           public String say() {
               if (count>0){
