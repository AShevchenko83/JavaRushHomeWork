...
7.1. Ввод заканчивается, как только вводится строка не совпадающая с одной из: "cartoon",
"thriller", "soapOpera".
...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        while (true)
        {
            ...
            if (s.equals("soapOpera")||s.equals("cartoon")||s.equals("thriller")) list.add(s);
            else break;
        }
...
8.2 вывести на экран movie.getClass().getSimpleName()
        */
        for (String s :list             )
        {
            Movie mov = MovieFactory.getMovie(s);
