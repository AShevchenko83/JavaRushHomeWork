...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            java.lang.String isString1 = string1!=null? "yes":"no";
            writer.println(isString1);
            if(isString1!=null){

                writer.println(string1.number);
            }
            java.lang.String isString2 = string2!=null? "yes":"no";
            writer.println(isString2);
            if(isString2!=null){
        ...
        public synchronized void load(InputStream inputStream) throws Exception {
            ...
            int beginCount = countStrings;
            java.lang.String isString1 = reader.readLine();
            if(isString1.equals("yes")){
                int number = Integer.parseInt(reader.readLine());
                countStrings=number-1;
                string1 = new String();
            }
            else string1=null;
            java.lang.String isString2 = reader.readLine();
            if(isString2.equals("yes")){
                int number = Integer.parseInt(reader.readLine());
                countStrings = number-1;
                string2 = new String();
            }
            else string2=null;
            countStrings=beginCount;
            reader.close();
        }
    }
